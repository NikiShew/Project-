...
function addProduct(product) {
    ...
    const dataInStorage = localStorage.getItem('card-products')
    const products = dataInStorage ? JSON.parse(dataInStorage) : [];
    products.push(product)
    console.log(products)
    localStorage.setItem('card-products', JSON.stringify(products))
